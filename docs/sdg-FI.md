...
Energiankulutus on minimoitu sillä, että on vain pieni määrä videoita.
...
Sovelluksemme pyrkii edistämään SDG16-tavoitteita varmistamalla, että digitaalinen ympäristö on turvallinen, läpinäkyvä ja kunnioittaa tekijänoikeuksia. Sovelluksesta voi tulla julkisilla paikoilla meluhaittaa. Sovelluksemme voi edistää kulttuurien välistä ymmärrystä tarjoamalla monipuolista sisältöä.
...
Sovelluksemme kehityksessä käytetään realistisia aikatauluja, mikä ehkäisee uupumusta ja takaa kestävän työrytmin.
